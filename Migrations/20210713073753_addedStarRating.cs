...
{
    public partial class addedStarRating : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    pictures = table.Column<string>(maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    license_plate = table.Column<string>(maxLength: 100, nullable: false),
                    ...
                    blocked_license_plate = table.Column<string>(maxLength: 100, nullable: true),
                    blockedBy_license_plate = table.Column<string>(maxLength: 100, nullable: true),
                    owner_id = table.Column<string>(maxLength: 450, nullable: false),
                    Lat = table.Column<double>(type: "Float", nullable: false),
                    Lng = table.Column<double>(type: "Float", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Car_1", x => x.license_plate);
                    table.ForeignKey(
                        name: "FK_Car_AspNetUsers",
                        column: x => x.owner_id,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
